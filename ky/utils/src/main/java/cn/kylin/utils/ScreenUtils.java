...
public final class ScreenUtils {
    ...
    public static int dp2px( float dpValue) {
        final float density = Utils.getContext().getResources().getDisplayMetrics().density;
        return (int) (dpValue * density + 0.5f);
    }

    public static int sp2px( float spValue) {
        final float scaledDensity = Utils.getContext().getResources().getDisplayMetrics().scaledDensity;
     ...
     * 隐藏虚拟按键，并且全屏
     */
    public static void BottomUIMenu(Activity mActivity ,boolean isShow) {
        //隐藏虚拟按键，并且全屏
        if (Build.VERSION.SDK_INT > 11 && Build.VERSION.SDK_INT < 19) { // lower api
            View v = mActivity.getWindow().getDecorView();
            if (isShow){
     ...
     * 隐藏虚拟按键，并且全屏
     */
    public static void showBottomUIMenu(Activity mActivity) {
        //隐藏虚拟按键，并且全屏
        if (Build.VERSION.SDK_INT > 11 && Build.VERSION.SDK_INT < 19) { // lower api
            View v = mActivity.getWindow().getDecorView();
            v.setSystemUiVisibility(View.VISIBLE);
