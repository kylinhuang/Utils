...
import cn.kylin.utils.HongbaoSignature;
import cn.kylin.utils.LogUtils;
import cn.kylin.utils.PowerUtil;
...
//        if (sharedPreferences == null) return;
        ...
        LogUtils.e(" onAccessibilityEvent " + event);
...
// 第三：在不同的页面我们需要做什么事情，点击哪个控件。
            ...
            // aak - 聊天页面 按钮
            List<AccessibilityNodeInfo> chatNodes = nodeInfo.findAccessibilityNodeInfosByViewId("com.tencent.mm:id/aak");

            if ( chatNodes.isEmpty() ) {
                //不在聊天页面 不好说在哪儿
            }else{
                //在聊天页面
//                List<AccessibilityNodeInfo> titleNodes = nodeInfo.findAccessibilityNodeInfosByViewId("com.tencent.mm:id/ha");
//                //ha 聊天页面 title
